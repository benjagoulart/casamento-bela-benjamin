...
export default function Home() {
  return (
    <>
      {/* ════════════════════════════════
          HERO — fullscreen estilo editorial
      ════════════════════════════════ */}
      <section
      ...
      >
        ...
        {/* ── Conteúdo central ── */}
        <div className="relative z-10 flex flex-col items-center text-center px-6 py-24 gap-0 max-w-lg w-full">

          {/* Monograma — mix-blend-mode:multiply remove o fundo branco */}
          <div className="mb-3" style={{ mixBlendMode: 'multiply' }}>
            <Image
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="w-1.5 h-1.5 rotate-45" style={{ backgroundColor: '#BA908B' }} />
      ...
      <section className="py-20 px-6" style={{ backgroundColor: '#F5EBE3' }}>
        <AnimatedSection className="max-w-2xl mx-auto text-center flex flex-col items-center gap-6">
          <div className="flex items-center gap-4 w-full">
            ...
            <div className="w-1.5 h-1.5 rotate-45" style={{ backgroundColor: '#BA908B', opacity: 0.6 }} />
            <div className="flex-1 h-px" style={{ backgroundColor: '#D4CBC7' }} />
          </div>
          <p
            style={{
        ...
        <AnimatedSection className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center mb-14 gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="h-px w-16" style={{ backgroundColor: '#D4CBC7' }} />
      ...
      {/* ════════════════════════════════
          RODAPÉ DA SEÇÃO — monograma
      ════════════════════════════════ */}
      <section className="py-20 px-6 flex flex-col items-center gap-6" style={{ backgroundColor: '#F5EBE3' }}>
